...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./api/shared.Condition":                               schema__api_nmstate_shared_Condition(ref),
		"./api/shared.NodeNetworkConfigurationEnactmentStatus": schema__api_nmstate_shared_NodeNetworkConfigurationEnactmentStatus(ref),
		"./api/shared.NodeNetworkConfigurationPolicySpec":      schema__api_nmstate_shared_NodeNetworkConfigurationPolicySpec(ref),
		"./api/shared.NodeNetworkConfigurationPolicyStatus":    schema__api_nmstate_shared_NodeNetworkConfigurationPolicyStatus(ref),
		"./api/shared.NodeNetworkStateStatus":                  schema__api_nmstate_shared_NodeNetworkStateStatus(ref),
		"./api/shared.State":                                   schema__api_nmstate_shared_State(ref),
	}
}
