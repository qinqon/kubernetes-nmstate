...
# Network policy support did not make it into OCP 4.20. We must not add manifests to the bundle.
# Doing so will break the validation pipeline. Once OLM gets the feature, uncomment the following lines.
#
