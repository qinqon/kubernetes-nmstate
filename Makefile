...
gen-openapi: $(OPENAPI_GEN)
	$(OPENAPI_GEN) --logtostderr=true -o "" -i ./api/nmstate/v1alpha1 -O zz_generated.openapi -p ./api/nmstate/v1alpha1 -h ./hack/boilerplate.go.txt -r "-"
	$(OPENAPI_GEN) --logtostderr=true -o "" -i ./api/nmstate/v1beta1 -O zz_generated.openapi -p ./api/nmstate/v1beta1 -h ./hack/boilerplate.go.txt -r "-"
	$(OPENAPI_GEN) --logtostderr=true -o "" -i ./api/nmstate/shared -O zz_generated.openapi -p ./api/nmstate/shared -h ./hack/boilerplate.go.txt -r "-"
